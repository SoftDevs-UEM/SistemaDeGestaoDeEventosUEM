    ...
    <section className="hero">
      ...
      <section className="featured-events">
        <div className="container">
          <h2 className="section-title">Eventos em <span className="highlight">Destaque</span></h2>
          <p className="section-subtitle">Descubra os eventos mais esperados da Universidade</p>
              ...
              <div key={event.id} className="event-card">
                ...
                <div className="event-info">
                  ...
                  <div className="event-meta">
                    <span><i className="fas fa-calendar-alt"></i> {event.date}</span>
                    <span><i className="fas fa-map-marker-alt"></i> {event.location}</span>
                    <span><i className="fas fa-users"></i> {event.attendees} participantes</span>
                  </div>
